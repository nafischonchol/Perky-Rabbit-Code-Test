    ...
    <div class="flex flex-col min-h-screen">
      <div class="flex items-center justify-between bg-gray-800 py-4 px-6">
        ...
        <div class="relative" id="userButton" @click="toggleUserDropdown">
          <button class="flex items-center justify-center h-10 w-10 rounded-full bg-white text-gray-800 focus:outline-none">
            <i class="fas fa-user"></i>
          </button>
          <div
            id="userDropdown"
            class="absolute right-0 mt-2 w-48 bg-gray-800 rounded-md shadow-lg"
      ...
      <div class="flex flex-1">
        <sidebar
          ...
          @update:active-menu-item="activeMenuItem = $event"
        ></sidebar>
